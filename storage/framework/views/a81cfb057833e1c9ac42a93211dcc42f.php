<?php $__env->startSection('title', 'Registrar Acción de Agenda'); ?>
...
<div class="page-default wz-wrap">
  ...
  <div class="screen-head">
    ...
    <div class="head-actions">
      <?php if (isset($component)) { $__componentOriginalff0af4a68f2c2727f26692b9778d11e0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalff0af4a68f2c2727f26692b9778d11e0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.btn-ejemplo','data' => ['tipo' => 'agenda_syd']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('btn-ejemplo'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tipo' => 'agenda_syd']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalff0af4a68f2c2727f26692b9778d11e0)): ?>
<?php $attributes = $__attributesOriginalff0af4a68f2c2727f26692b9778d11e0; ?>
<?php unset($__attributesOriginalff0af4a68f2c2727f26692b9778d11e0); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalff0af4a68f2c2727f26692b9778d11e0)): ?>
<?php $component = $__componentOriginalff0af4a68f2c2727f26692b9778d11e0; ?>
<?php unset($__componentOriginalff0af4a68f2c2727f26692b9778d11e0); ?>
<?php endif; ?>
      <a href="<?php echo e(route('agenda.index')); ?>" class="btn btn-outline">Volver a agenda</a>
    </div>
  </div>
  ...
  <form method="POST" action="<?php echo e(route('agenda.store')); ?>" id="wzForm" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <?php if($errors->any()): ?>
      <div class="toast toast-error u-toast-inline-top">
        ...
        <ul style="margin:8px 0 0 16px"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
      </div>
    <?php endif; ?>
    ...
    <div class="wz-card wz-panel activo" data-panel="1">
      ...
      <div class="wz-sub" id="bloqueBuscar" style="margin-top:16px; display:none">
        ...
        <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Buscar trámite, folio u homoclave','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Buscar trámite, folio u homoclave','class' => 'span-2']); ?>
                <input type="text" id="buscadorTramite" placeholder="Escribe al menos 2 letras..." autocomplete="off">
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $attributes = $__attributesOriginal3b5b6c017a1d78804499e3e67726624c; ?>
<?php unset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $component = $__componentOriginal3b5b6c017a1d78804499e3e67726624c; ?>
<?php unset($__componentOriginal3b5b6c017a1d78804499e3e67726624c); ?>
<?php endif; ?>
      ...
      <div class="wz-foot">
        ...
        <div class="wz-foot-right">
          <a href="<?php echo e(route('agenda.index')); ?>" class="btn btn-outline">Cancelar</a>
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Nombre oficial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Nombre oficial']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Dependencia responsable']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Dependencia responsable']); ?>
                <input type="hidden" name="tramite_dependencia_id" value="<?php echo e(auth()->user()->dependencia_id); ?>">
                <input type="text" value="<?php echo e(auth()->user()->dependencia->nombre ?? 'Sin dependencia asignada'); ?>" disabled class="u-input-disabled">
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $attributes = $__attributesOriginal3b5b6c017a1d78804499e3e67726624c; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Unidad administrativa']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Unidad administrativa']); ?>
                <select name="tramite_unidad_id">
                <option value="">Seleccione</option>
                <?php $__currentLoopData = ($misUnidades ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Persona servidora pública responsable']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Persona servidora pública responsable']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Sector principal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Sector principal']); ?>
                <select name="tramite_sector_id" id="selSector" onchange="cargarSubsectores()">
                <option value="">Seleccione</option>
                <?php $__currentLoopData = ($sectores ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Subsector o actividad relacionada']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Subsector o actividad relacionada']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Clave u homoclave','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Clave u homoclave','class' => 'span-2']); ?>
                ...
                <small class="help-small">Se genera automáticamente: <?php echo e(config('punta.prefijo_homoclave', 'LPZ')); ?>-(siglas dependencia)-(siglas unidad)-(consecutivo).</small>
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $attributes = $__attributesOriginal3b5b6c017a1d78804499e3e67726624c; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Tipo de registro']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tipo de registro']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Resumen del fundamento','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Resumen del fundamento','class' => 'span-2']); ?>
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Objetivo del trámite','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Objetivo del trámite','class' => 'span-2']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Población objetivo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Población objetivo']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Volumen anual estimado']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Volumen anual estimado']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Frecuencia']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Frecuencia']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Plazo máximo de resolución']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Plazo máximo de resolución']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Unidad de plazo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Unidad de plazo']); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => '¿Está dirigido a grupos de atención prioritaria?','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '¿Está dirigido a grupos de atención prioritaria?','class' => 'span-2']); ?>
              <div class="wz-sino">
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => '¿Guarda relación con otros trámites o servicios?','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '¿Guarda relación con otros trámites o servicios?','class' => 'span-2']); ?>
              <div class="wz-sino">
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Pago de derechos','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Pago de derechos','class' => 'span-2']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Número de copias']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Número de copias']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Precio por copia (pesos)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Precio por copia (pesos)']); ?>
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Visitas requeridas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Visitas requeridas']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Número de áreas que participan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Número de áreas que participan']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Tiempo promedio de traslado por visita']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tiempo promedio de traslado por visita']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Tiempo promedio de espera por visita']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tiempo promedio de espera por visita']); ?>
              <div style="display:flex; gap:6px">
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Tiempo promedio de atención por visita']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Tiempo promedio de atención por visita']); ?>
              <div style="display:flex; gap:6px">
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => '¿Existen procesos redundantes?','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '¿Existen procesos redundantes?','class' => 'span-2']); ?>
              <div class="wz-sino">
      ...
      <div class="wz-tipo" id="bloqueSimplificacion">
        ...
        <div class="wz-tipo-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Objetivo de la simplificación','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Objetivo de la simplificación','class' => 'span-2']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Meta esperada']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Meta esperada']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Indicador de cumplimiento']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Indicador de cumplimiento']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => '¿Deriva de recomendación de la autoridad?','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '¿Deriva de recomendación de la autoridad?','class' => 'span-2']); ?>
              <div class="wz-sino">
      ...
      <div class="wz-tipo" id="bloqueDigitalizacion">
        ...
        <div class="wz-tipo-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Nivel actual de digitalización']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Nivel actual de digitalización']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Objetivo de la digitalización','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Objetivo de la digitalización','class' => 'span-2']); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => '¿Requiere interoperabilidad con otra institución?','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => '¿Requiere interoperabilidad con otra institución?','class' => 'span-2']); ?>
              <div class="wz-sino">
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Estatus actual']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Estatus actual']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Observaciones','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Observaciones','class' => 'span-2']); ?>
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <div class="wizard-fields">
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Dependencia (de la acción)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Dependencia (de la acción)']); ?>
                <input type="hidden" name="dependencia_id" value="<?php echo e(auth()->user()->dependencia_id); ?>">
                <input type="text" value="<?php echo e(auth()->user()->dependencia->nombre ?? 'Sin dependencia asignada'); ?>" disabled class="u-input-disabled">
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Responsable de seguimiento']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Responsable de seguimiento']); ?>
                <input name="responsable" type="text" value="<?php echo e(auth()->user()->name); ?>" placeholder="Usuario enlace">
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $attributes = $__attributesOriginal3b5b6c017a1d78804499e3e67726624c; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Sujeto obligado']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Sujeto obligado']); ?>
                <input type="text" value="<?php echo e(auth()->user()->dependencia->nombre ?? '—'); ?>" readonly class="u-input-readonly">
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b5b6c017a1d78804499e3e67726624c)): ?>
<?php $attributes = $__attributesOriginal3b5b6c017a1d78804499e3e67726624c; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Fecha de inicio']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha de inicio']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Fecha estimada de conclusión']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha estimada de conclusión']); ?>
...
<?php endif; ?>
      ...
      <div class="wz-bloque">
        ...
        <div class="wz-bloque-body">
          <?php if (isset($component)) { $__componentOriginal3b5b6c017a1d78804499e3e67726624c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b5b6c017a1d78804499e3e67726624c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field-help','data' => ['label' => 'Carga de anexos','class' => 'span-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field-help'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Carga de anexos','class' => 'span-2']); ?>
...
(function () {
  ...
  function buscar(q) {
    fetch('<?php echo e(route('api.tramites.buscar')); ?>?q=' + encodeURIComponent(q), { headers: { 'Accept': 'application/json' } })
  ...
  function precargarTramite(id) {
    var url = '<?php echo e(url('api/tramites')); ?>/' + id + '/detalle';
  ...
  var SUBSECTORES = <?php echo json_encode($subsectoresPorSector ?? [], 15, 512) ?>;
  ...
  (function previsualizarHomoclave() {
    ...
    function actualizar() {
      ...
      fetch('<?php echo e(url('api/homoclave/previsualizar')); ?>?dependencia_id=' + depId + '&unidad_id=' + uniId, {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\punta\resources\views/screens/agenda/create.blade.php ENDPATH**/ ?>