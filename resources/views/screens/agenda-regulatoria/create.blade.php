        ...
        <div class="wz-tipo-body">
          <div class="wizard-fields">
            <x-field-help label="Nivel actual de digitalización">
                ...
                <option value="1">Nivel 1 — Información en línea</option>
                <option value="2">Nivel 2 — Descarga de formatos</option>
                <option value="3">Nivel 3 — Trámite en línea parcial</option>
                <option value="4">Nivel 4 — Trámite y pago en línea</option>
                <option value="5">Nivel 5 — Expediente digital completo</option>
              </select>
              </x-field-help>
